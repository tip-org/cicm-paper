...
%	\end{itemize}
\end{itemize}
This subset represent a basic functional programming language and is sufficiently expressive for our current set of standard benchmarks. Further extensions of the supported subset are likely.
...
Finally, the benchmark problem itself is declared with the keyword \texttt{assort-not}:
